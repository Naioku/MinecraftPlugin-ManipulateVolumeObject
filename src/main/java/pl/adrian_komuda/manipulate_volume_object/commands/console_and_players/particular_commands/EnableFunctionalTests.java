...
public class EnableFunctionalTests implements CommandsPerformers {
    @Override
    public void perform(CommandSender commandSender, String command, List<String> args) {
        TestFlags.FUNCTIONAL_TEST_FLAG = true;
        commandSender.sendMessage(String.valueOf(MessagesWith0Params.FUNCTIONAL_TESTS_ENABLED.getMessage()));
    }
}
